...
The code chunk below install and load [sf](https://r-spatial.github.io/sf/) , [tmap](https://cran.r-project.org/web/packages/tmap/), [tidyverse](https://tidyverse.tidyverse.org/) packages into R environment (p_load from [pacman](https://github.com/trinker/pacman))
