...
map_honeycomb = tm_shape(total_trips_per_grid_wdmp) +
  tm_fill(
    col = "total_trips",
    palette = "Reds",
    style = "cont",
...
map_honeycomb = tm_shape(total_trips_per_grid_wdap) +
  tm_fill(
    col = "total_trips",
    palette = "Reds",
    style = "cont",
...
```{r}
map_honeycomb = tm_shape(total_trips_per_grid_wemp) +
  tm_fill(
    col = "total_trips",
    palette = "Reds",
    style = "cont",
...
```{r}
map_honeycomb = tm_shape(total_trips_per_grid_weep) +
  tm_fill(
    col = "total_trips",
    palette = "Reds",
    style = "cont",
...
```{r}
coords <- coordinates(busstop3414)
