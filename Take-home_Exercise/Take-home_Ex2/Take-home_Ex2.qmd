...
From the above results, I notice that all explanatory variables are statistically significant(p-value\< 0.05) but all coefficient are as desired and the Rsquared for uncSIM2 is lower as compared to uncSIM and uncSIM1 which is favorable, suggesting that reducing the unnecessary variables resulting in better model.
